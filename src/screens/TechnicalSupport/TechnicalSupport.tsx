                ...
                >
                  {message.type === "agent" && (
                    <div className="flex items-center gap-2 mb-2">
                      <img src="/img/logo-3.png" alt="Petrolife" className="w-6 h-6" />
                    </div>
                  )}
...
const TechnicalSupport = () => {
  ...
  return (
    ...
    >
      {/* Tabs */}
      <div className="flex items-center gap-2 w-full border-b border-gray-200 pb-4">
        <button
      ...
      <div className="w-full mt-6">
        {activeTab === "contact" ? <ContactUsTab /> : <CompanyFAQ />}
      </div>
    </div>
  );
};
